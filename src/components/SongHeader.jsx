  ...
  return (
    <div className='flex justify-evenly  bg-gray-300 font-serif  max-[900px]:flex-col-reverse gap-4  items-center p-4'>
        <div className='flex mr-[10%] gap-2 max-[900px]:w-screen max-[900px]:justify-end'>
          <button className='border-2 hover:bg-gray-200 hover:text-white border-gray-400 h-8 tracking-[1px] flex sm:w-[140px] justify-center items-center text-[14px] bg-white rounded-lg px-6'>
